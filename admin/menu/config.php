...
switch ($do) {
    ...
    default:
        ...
        $show_ = show($dir."/form_config", array("limits" => _config_c_limits,
                                                 ...
                                                 "c_eml_reg" => txtArea(re($gets['eml_reg'])),
                                                 "c_eml_pwd" => txtArea(re($gets['eml_pwd'])),
                                                 "c_eml_nletter" => txtArea(re($gets['eml_nletter'])),
                                                 "c_eml_pn" => txtArea(re($gets['eml_pn'])),
                                                 "c_eml_fabo_npost" => txtArea(re($gets['eml_fabo_npost'])),
                                                 "c_eml_fabo_tedit" => txtArea(re($gets['eml_fabo_tedit'])),
                                                 "c_eml_fabo_pedit" => txtArea(re($gets['eml_fabo_pedit'])),
